	...
	<form class="form-inline" action="${pageContext.request.contextPath}/recruit/list.do" method="post">
	  ...
	  <button type="submit" class="btn btn-default">查询</button>	
	    <!--div class="input-group" style="width: 300px">
		      <input type="text" class="form-control" name="name"  value="${s_recruit.name }" placeholder="请输入姓名">&nbsp;
		      <input type="text" class="form-control" name="idcard"  value="${s_recruit.idcard }" placeholder="请输入身份证">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="gridSystemModalLabel">招聘基本信息表</h4>
      </div>
...
<div id="myModalOfHealth" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">体检表</h4>
      </div>
      <div class="modal-body">
        <h4>体检项目</h4>
        ...
        <h4>本单位指定医疗机构</h4>
        <p>合作医院 <a href="#" role="button" class="btn btn-default popover-test" title="A Title" data-content="And here's some amazing content. It's very engaging. right?">查看</a> 建议到制定医院进行体检.</p>
